        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div>
            ...
            <p className="mt-3 text-sm text-ink-muted max-w-xs leading-relaxed">
              Amplify the givers. Build the sovereign infrastructure.
              Arrive at January 1, 2029 ready.
            </p>
          ...
          <div className="space-y-2 text-sm">
            ...
            <Link href="/ecosystem" className="block hover:text-accent-teal">
              The Ecosystem
            </Link>
            <Link href="/plays" className="block hover:text-accent-teal">
              The Five Plays
            </Link>
          </div>
          <div className="space-y-2 text-sm">
